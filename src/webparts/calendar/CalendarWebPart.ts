  ...
  public render(): void {
    const element: React.ReactElement<ICalendarProps> = React.createElement(
      Calendar,
      {
        ...
        allowBackup: this.properties.allowBackup,
        allowEdit: this.properties.allowEdit,        
        allowPending: this.properties.allowPending,
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneToggle('allowBackup', {
                  label: 'Enable Backup',
                  onText: 'On',
                  offText: 'Off'
                }),                
                PropertyPaneToggle('allowEdit', {
                  label: 'Enable Editing Events',
                  onText: 'On',
                  offText: 'Off'
                }),                
                PropertyPaneToggle('allowPending', {
                  label: 'Show Pending Events (Requires Refresh)',
                  onText: 'On',
                  offText: 'Off'
                }),
